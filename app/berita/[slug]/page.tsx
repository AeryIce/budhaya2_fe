    ...
    <Container>
      <article className="py-10">
        <div className="max-w-4xl">
          <Link href="/berita" className="text-sm font-medium text-sky-800 underline decoration-sky-300 underline-offset-4">
            ← Kembali ke berita
          </Link>
          <div className="mt-5 text-sm font-semibold uppercase tracking-[0.18em] text-sky-700">{post.category}</div>
          ...
          <div className="mt-3 text-xs font-medium uppercase tracking-[0.16em] text-slate-500">Publikasi demo • {post.date}</div>
        </div>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <aside className="space-y-4">
            <div className="rounded-[28px] border border-sky-100 bg-white p-6 shadow-sm">
              <div className="text-sm font-semibold text-slate-900">Mengapa halaman detail ini penting?</div>
              <div className="mt-3 text-sm leading-7 text-slate-600">
                Saat demo dibuka, pihak sekolah dapat langsung melihat bahwa setiap berita tidak berhenti di kartu ringkas, tetapi bisa berkembang menjadi halaman detail yang rapi, nyaman dibaca, dan siap diisi konten resmi sekolah.
              </div>
            </div>
            ...
            <div className="rounded-[28px] border border-sky-100 bg-sky-950 p-6 text-white shadow-sm">
              ...
              <div className="mt-3 text-lg font-semibold">Konten sekolah terasa lebih hidup</div>
              <div className="mt-2 text-sm leading-7 text-blue-50">
                Format halaman detail seperti ini membantu website tampil lebih profesional saat memuat berita, pengumuman, maupun dokumentasi kegiatan sekolah.
              </div>
            </div>
          </aside>
        </div>
